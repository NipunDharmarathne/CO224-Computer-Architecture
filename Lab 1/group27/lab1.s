...
main:
	...
	ldr r6, [r0, #12];	@ load a[3] to r6
	ldr r7, [r1, #4];	@ load b[1] to r7
 
	add r5, r5, #6;		@ r5 = 6 + a[9]
	sub r5, r5, r6;		@ r5 = 6 + a[9] - a[3]
	add r5, r5, r7;		@ r5 = 6 + a[9] - a[3] + b[1]
	sub r5, r5, r2;		@ r5 = 6 + a[9] - a[3] + b[1] - c
	sub r5, r5, r3;		@ r5 = 6 + a[9] - a[3] + b[1] - c - d 
	add r5, r5, r4;		@ r5 = 6 + a[9] - a[3] + b[1] - c - d + e = 6 + a[9] - a[3] + b[1] – ( c + d - e )
 
	str r5, [r1, #16];	@ store r5 to b[4]
